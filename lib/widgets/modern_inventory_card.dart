...
class _ModernInventoryCardState extends State<ModernInventoryCard>
  ...
  Widget _buildWarningBadge(bool isDark) => Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                color:
                    isDark ? const Color(0xFFFCA5A5) : const Color(0xFF92400E),
                fontSize: 12,
  ...
  /// قسم الباركود
  Widget _buildBarcodeSection(String barcode, bool isDark) => Container(
        padding: const EdgeInsets.all(16),
        decoration: BoxDecoration(
