            ...
            child: SizedBox(
              ...
              child: PageView(
                ...
                onPageChanged: (int index) {
                  debugPrint('📱 Mobile Layout - Page changed to: $index');
                  onPageChanged(index);
                },
                children: <Widget>[
                  TabErrorOverlay(
                  ...
                  TabErrorOverlay(
                    ...
                    childBuilder: (BuildContext ctx) {
                      ...
                      debugPrint(
                          '🏪 Building POS tab at index 5 (Mobile Layout)');
                      debugPrint(
                  ...
                  TabErrorOverlay(
                    ...
                    childBuilder: (BuildContext ctx) =>
                        InventoryDisplayTabRiverpod(
                      onNavigateToQuickSell: () => pageController.animateToPage(
                          1,
